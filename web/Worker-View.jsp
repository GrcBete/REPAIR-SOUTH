<%-- 
    Document   : Worker-View
    Created on : Sep 24, 2021, 12:46:38 PM
    Author     : GSSB
--%>
...
.dropdown:hover .dropdown-content {
  display: block;
    ...
    <body style="background-color: white">
        ...
        String mysql = "Select * from Worker_Info where User_Name = '"+userName+"'";
        Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        if (result.next()){
         ...
         String mysql1 = "Select * from Booking_Details where Worker_Id = "+id+"";
         
         pst1 = conn.prepareStatement(mysql1);
         result1 = pst1.executeQuery();
         while (result1.next()){
         String userB =result1.getString(2);   
         String loc =result1.getString(3);
         String dat =result1.getString(4);
            %>
        ...
        //session.setAttribute("Worker_ID", id);
            ...
            <div class="employee-box-container" >
                <div class="emlployee-box">
                    ...
                    <div class="Comments">
                        <p><%=userB%> Made a booking from the date of <%=dat%> 
                        at  <%=loc%>.
                        </p>
